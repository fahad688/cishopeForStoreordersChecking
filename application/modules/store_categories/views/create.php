...
?>
	    	...
	    	<!-- for creating items Category titlle,Category price,was price,Category description,big pic,small pic ,status  -->
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span> Category Details</h2>
						<div class="box-icon">
					   ...
					   <?php 
						   ...
						   <div class="control-group">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span5" name="cat_title" value="<?= $cat_title ?>">
