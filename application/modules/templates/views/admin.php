...
<head>
    ...
    <!-- start: Favicon -->
    <link rel="shortcut icon" href="<?= base_url() ?>assets/adminfiles/img/favicon.ico">
    <!-- end: Favicon -->
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="<?= base_url() ?>store_order_status/manage"><i class="icon-file-alt"></i><span class="hidden-tablet"> Store Order Status</span></a></li>  
                    ...
                    <li><a href="<?= base_url() ?>enquiries/inbox"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>  
                     ...
                     <li><a href="<?= base_url() ?>blog/manage "><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Blog</span></a></li>
                        ...
                        <li><a href="<?= base_url() ?>store_accounts/manage"><i class="icon-briefcase"></i><span class="hidden-tablet">Account</span></a></li>
