...
function delete($update_id)
{
   if (!is_numeric($update_id)) 
    ...
    // fetch the id of the item to be deleted
...
function update($item_id)
{
    ...
    //  get an array of all the sub categories 
    $this->load->module('store_categories');
    $sub_categories=$this->store_categories->_get_all_sub_cats_for_dropdown();



   // get an array of all the assigned categories 
    ...
    // function of update item cat_id and view of updting color reference
