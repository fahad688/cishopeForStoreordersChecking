...
function _make_sure_delete_allowed($update_id)
{
    ...
    else
    {
        ...
        if($num_rows>0)
        {
            return FALSE; // delete not allowed since has item in shoppertrack and had made a purchased 
        }
...
function delete($update_id)
{
    ...
    elseif ($submit=="Yes-Delete") 
    {
        ...
        $flash_msg="The Account was successfull deleted";
...
{
    $update_id=8;
    $token=$this->_generate_toke($update_id);
    echo $token;
