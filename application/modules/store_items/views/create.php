...
if (isset($flash)) 
{
	echo $flash;
		...
		// for options of Upload image ,item color ,item size ,item catagories,delete item
			   ...
			   <div class="box-content">
			    ...
			    if ($big_pic=="") { ?>
				 ...
				 <a href="<?= base_url()?>store_items/deleteconf/<?= $update_id ?> "> <button type="button" class="btn btn-danger">Delete Item</button></a>
				  <a href="<?= base_url()?>store_items/view/<?= $update_id ?> "> <button type="button" class="btn btn-default">Show item in Shop</button></a>
...
<?php 
	if ($big_pic!="") { ?>
	 ...
	 <div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Item Image</h2>
				<div class="box-icon">
					<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
					<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
				</div>
	...
	<!-- for creating items item titlle,item price,was price,item description,big pic,small pic ,status  -->
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon edit"></i><span class="break"></span>Update Item Details</h2>
				<div class="box-icon">
					<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
					<a href="#" class="btn-close"><i class="halflings-icon remove"></i></a>
				</div>
				...
				<form class="form-horizontal" method = "post" action="<?= $form_location ?>">
				  <fieldset>
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" class="span5" name="item_title" value="<?= $item_title ?>">
					...
					<div class="control-group">
					  <label class="control-label" for="typeahead"> Was Price(optional) <span style="color:green;">
					  ...
					  <div class="controls">
						<input type="text" class="span1" name="was_price" value="<?= $was_price ?>">
						 ...
						 <!-- for dropdown selection of active and inactive  -->
						<div class="control-group">
