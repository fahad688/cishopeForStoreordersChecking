           ...
           <div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Upload Success</h2>
						<div class="box-icon">
					   ...
					   <div class="box-content">
						   <div class="alert alert-success">Your file was successfully uploaded!</div>>
							...
							<p>
								...
								?>
								<a href="<?= $edit_item_url ?>"><button type="button" class="btn btn-primary">Returm TO Main Update Item Details Page</button></a>
							</p>
					   </div>
				</div><!--/span-->
