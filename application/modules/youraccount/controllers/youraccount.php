...
{ 
     ...
     function test1()
     {
     	...
     	echo "The session has been set";
     	echo"<hr>";   	
     	echo anchor('Youraccount/test2',' Get(display) the  session varible')."<br>";
     	echo anchor('Youraccount/test3',' unset(destroy) the  session varible')."<br>";
     }
     ...
     function test2()
     {
     	...
     	{
     		echo "No session has been set";
     	}

     	echo"<hr>";	
     	echo anchor('Youraccount/test1','The session has been set')."<br>";
     	echo anchor('Youraccount/test3',' unset(destroy) the  session varible')."<br>";
     }
     ...
     function test3()
     {
     	...
     	echo "The session varible was unset.";
     	echo "<hr>";
     ...
     {
     	// NOTE: $login_type can be longterm or shortterm
     ...
     function _attempt_cart_divert($user_id)
     {
        ...
        if($num_rows>0)
        {
            // therev are records that needs to be corrected
     ...
     function submit()
     {
        ...
        $this->form_validation->set_rules('email','Email', 'required|min_length[7]|max_length[30]|valid_email');
        $this->form_validation->set_rules('pword','Password', 'required|min_length[7]|max_length[30]');
     ...
     function username_check($str)
     {
     	...
     	$error_msg='You did not submit a valid username and/or email ';
