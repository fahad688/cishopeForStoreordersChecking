...
class Store_orders extends MX_Controller {
    ...
    function _sent_auto_notify($update_id) {

    // generete autp notify to the customer when order status is updated 
        ...
        $msg .= 'The new order status for your order is' . $status_title . '.';
    ...
    //this gets called out bye browser and figure out what the order status is 
    ...
    function submit_order_status() {
        ...
        // get the current order status for this order 
            ...
            $this->_sent_auto_notify($update_id);
    ...
    function view() {
        ...
        //NOTE changed from ..._get_shopper_address in _get_shopper_adress

        //$data['customer_address'] = $this->store_accounts->_get_shopper_address($data['shopper_id'], '');
    ...
    function browse() {
        ...
        // count 0rders belong to this order status 
    ...
    function _generate_mysql_query($use_limit) {
        ...
        //echo'order_status: '.$order_status; die();
        ...
        //$mysql_query = "select * from store_orders where order_status=$order_status order by date_created desc";
          ...
          FROM store_orders INNER JOIN store_accounts ON 

          store_orders.shopper_id=store_accounts.id
...
// this gets call from paypal ipn listner , when an order is placed 
